...
please.prototype.setup = function () {
	...
	var config_appRemoteTargetPath = '/home/' + config_appName + '/bundle/programs/web.browser/app/';
...
please.prototype.deploy = function () {
	...
	var config_appRemoteTargetPath = '/home/' + config_appName;
	...
	bash.on('close', function (code) {
		if (code) {
			...
			taskList.execute('Configuring installation directory...', {
				command: 'sudo mkdir -p /home/' + config_appName
			});
...
please.prototype.delete = function () {
	...
	taskList.execute('Removing app files...', {
		command: 'sudo rm -rf /home/' + this.config.appName
	});
